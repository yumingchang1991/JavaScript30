...
|  30 | 2022-06-02 | Whack A Mole                 | 1) Use recursive function! <br> 2) Use `event.isTrusted` property to check if that event is triggered by human, true, or it's trigger by JavaScript |